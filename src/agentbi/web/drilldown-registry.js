/*
 * Declarative drilldown registry.
 *
 * Superset integration can generate this document from chart metadata.  The
 * workbench only renders trusted fields and never executes expressions from a
 * registry entry.
 */
window.AGENTBI_DRILLDOWN_REGISTRY = Object.freeze({
  version: 1,
  charts: {
    revenue: {
      ...
      levelOneLabel: '第 1 层 · 区域', levelOneTitle: '2024 Q4 各区域销售收入',
      bars: [['华东', 88, '420'], ['华南', 60, '280'], ['华北', 40, '190'], ['西南', 28, '130']],
      connectorTwo: '点击 华东，下钻维度：产品线',
      levelTwoLabel: '第 2 层 · 产品线', levelTwoTitle: '华东产品线贡献',
    ...
    structure: {
      ...
      levelOneLabel: '第 1 层 · 区域', levelOneTitle: '消费电子各区域销售收入',
      bars: [['华东', 88, '76'], ['华南', 63, '54'], ['华北', 41, '31'], ['西南', 24, '15']],
      connectorTwo: '点击 华东，下钻维度：渠道',
      levelTwoLabel: '第 2 层 · 渠道', levelTwoTitle: '华东消费电子渠道贡献',
